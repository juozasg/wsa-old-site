...
gem 'forem', :git => "git://github.com/juozasg/forem.git", :branch => 'wsa-1-0-stable'

gem 'cancan', '= 1.6.7' # this version works correctly
# gem 'forem', :path => "/home/juozas/src/forem"

gem 'forem-html_formatter', :git => 'git://github.com/juozasg/forem-html_formatter.git', :branch => "master"
